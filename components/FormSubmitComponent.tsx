...
import { SubmitForm } from '@/app/lib/actions/form'
        ...
        overflow-y-auto border shadow-xl shadow-blue-700 rounded'>
                {
                    content.map((element) => {
                        ...
                        isInvlaid={formErrors.current[element.id]}
              ...
              {  !pending &&  <><HiCursorClick className='mr-2' />  Submit </>} {pending && <ImSpinner2 className='animate-spin mr-2' /> }{' '}</Button>
        </div>
    </div>
  )
}
